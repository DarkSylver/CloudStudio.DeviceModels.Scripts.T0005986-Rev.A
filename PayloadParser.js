function parseUplink(device, payload)
{
    ...
    var data = decodeUplink({'bytes': payload.asBytes(), 'fPort': 10}).data;
 
    var light = device.endpoints.byAddress("1").updateLightSensorStatus(data['light_intensity']);
    var watermark1_frequency = device.endpoints.byAddress("2").updateGenericSensorStatus(data['watermark1_frequency']);
    var watermark1_tension = device.endpoints.byAddress("3").updateGenericSensorStatus(data['watermark1_tension']);
    var watermark2_frequency = device.endpoints.byAddress("4").updateGenericSensorStatus(data['watermark2_frequency']);
    var watermark2_tension = device.endpoints.byAddress("5").updateGenericSensorStatus(data['watermark2_tension']);
