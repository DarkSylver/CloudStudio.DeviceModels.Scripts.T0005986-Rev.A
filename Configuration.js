...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // temperature sensor, while the second one is a carbon dioxide sensor.
    ...
    var light = endpoints.addEndpoint("1", "Light Intensity", endpointType.lightSensor);

    var watermark1_frequency = endpoints.addEndpoint("2", "Watermark 1 Frequency", endpointType.genericSensor);
    watermark1_frequency.variableTypeId = 1362;

    var watermark1_tension = endpoints.addEndpoint("3", "Watermark 1 Tension", endpointType.genericSensor);
    watermark1_tension.variableTypeId = 1366;

    var watermark2_frequency = endpoints.addEndpoint("4", "Watermark 2 Frequency", endpointType.genericSensor);
    watermark2_frequency.variableTypeId = 1362;

    var watermark2_tension = endpoints.addEndpoint("5", "Watermark 2 Tension", endpointType.genericSensor);
    watermark2_tension.variableTypeId = 1366;
